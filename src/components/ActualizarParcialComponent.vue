<template>
    <div class="actualizar-parcial-component">
        <h3>Actualizar Parcial</h3>
        <form @submit.prevent="actualizar">
            ...
            <div class="form-group">
                ...
                <input v-model="formulario.lastName" type="text" />
            </div>
            <div class="form-group">
    ...
    methods: {
        async autocompletarCampos() {
            ...
            try {
                ...
                // Solo autollenar si existe el estudiante
                if (estudiante) {
                    this.formulario = {
                        id: estudiante.id,
